$(document).ready(function () {
    ...
    $('#prov_code').change(function() {
        ...
        fetch(`${baseUrl}/api/v1/kotas?code=` + prov_code)
    ...
    $('#kota_code').change(function() {
        ...
        fetch(`${baseUrl}/api/v1/kecamatans?code=` + kota_code)
            .then(response => response.json())
            .then(
    ...
    $('#kec_code').change(function() {
        ...
        fetch(`${baseUrl}/api/v1/kelurahans?code=` + kec_code)
            .then(response => response.json())
            .then(
        ...
        fetch(`${baseUrl}/api/v1/zips?code=` + kec_code)
            .then(response => response.json())
            .then(
