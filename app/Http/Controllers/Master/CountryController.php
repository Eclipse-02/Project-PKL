        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        if ($row->is_active == 'Y') {
                            $btn = '
                            <form action="countries/'.$row->id.'" method="POST" class="text-center">

                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-md me-1" href="countries/'.$row->id.'" >
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-md me-1" href="countries/'.$row->id.'/edit" >
                                ...
                                '.csrf_field().'
                                '.method_field("DELETE").'
                                <input type="hidden" id="swal_name_val" value="'.$row->con_name.'">
