...
class BranchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        if ($row->is_active == 'Y') {
                            $btn = '
                            <form action="branches/'.$row->id.'" method="POST" class="text-center">

                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-md me-1" href="branches/'.$row->id.'" >
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-md me-1" href="branches/'.$row->id.'/edit" >
                                ...
                                '.csrf_field().'
                                '.method_field("DELETE").'
                                <input type="hidden" id="swal_name_val" value="'.$row->branch_name.'">
        ...
        return view('scaffolds.master.branchs.index', compact('provinsis', 'areas'));
    }
    ...
    public function edit($branch)
    {
        ...
        return view('scaffolds.master.branchs.edit', compact('data', 'areas', 'provinsis'));
    }
