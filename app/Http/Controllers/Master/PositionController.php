...
class PositionController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = Position::where('coy_id', Auth::user()->coy_id)->get();
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        if ($row->is_active == 'Y') {
                            $btn = '
                            <form action="positions/'.$row->id.'" method="POST" class="text-center">

                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-md me-1" href="positions/'.$row->id.'" >
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-md me-1" href="positions/'.$row->id.'/edit" >
                                ...
                                '.csrf_field().'
                                '.method_field("DELETE").'
                                <input type="hidden" id="swal_name_val" value="'.$row->poss_name.'">
    ...
    public function edit($position)
    {
        ...
        return view('scaffolds.master.positions.edit', compact('data'));
    }
