...
class JobController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = Job::where('coy_id', Auth::user()->coy_id)->get();
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        if ($row->is_active == 'Y') {
                            $btn = '
                            <form action="jobs/'.$row->id.'" method="POST" class="text-center">

                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-md me-1" href="jobs/'.$row->id.'" >
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-md me-1" href="jobs/'.$row->id.'/edit" >
    ...
    public function edit($job)
    {
        ...
        return view('scaffolds.master.jobs.edit', compact('data'));
    }
