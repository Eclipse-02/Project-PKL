...
class BankController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        if ($row->is_active == 'Y') {
                            $btn = '
                            <form action="banks/'.$row->id.'" method="POST" class="text-center">

                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-md me-1" href="banks/'.$row->id.'" >
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-md me-1" href="banks/'.$row->id.'/edit" >
                                ...
                                '.csrf_field().'
                                '.method_field("DELETE").'
                                <input type="hidden" id="swal_name_val" value="'.$row->bank_name.'">
        ...
        return view('scaffolds.master.banks.index', compact('provinsis'));
    }
    ...
    public function show($bank)
    {
        ...
        if (!$data) {
            Alert::toast('Anda Tidak Memiliki Akses Untuk Membaca Data Ini!', 'error');
    ...
    public function edit($bank)
    {
        ...
        return view('scaffolds.master.banks.edit', compact('data', 'provinsis'));
    }
