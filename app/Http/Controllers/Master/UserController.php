...
class UserController extends Controller
{
    ...
    {
        $employees = Employee::select('empl_id', 'empl_name')->whereNotIn('empl_id', function($q) {
            $q->select('empl_id')->from('users');
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        <form action="user/'.$row->empl_id.'" method="POST" class="text-center">
                                ...
                                '.csrf_field().'
                                '.method_field("DELETE").'
                                <input type="hidden" id="swal_name_val" value="'.$row->name.'">
        ...
        return view('scaffolds.master.users.index', compact('employees', 'branches'));
    }
    ...
    public function edit($user)
    {
        ...
        return view('scaffolds.master.users.edit', compact('data', 'employees', 'branches'));
    }
