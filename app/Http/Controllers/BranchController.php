        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->branch_name.' ?\');" action="branchs/'.$row->id.'" method="POST">

                            <a class="btn btn-info" href="branchs/'.$row->id.'" >
                            ...
                            <a class="btn btn-primary" href="branchs/'.$row->id.'/edit" >
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
