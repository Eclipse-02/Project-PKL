...
class RegisterPackageController extends Controller
{
    ...
    public function create()
    {
        ...
        $prov = Provinsi::select('prov_code', 'provinsi')->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 'appl_is_copy_pass_name' => 'required',
        ...
        if ($validator->fails()) {
            ...
            $new_data = RegisterPackage::create([
                ...
                'appl_st' => $request->action == 'submit' ? 'NW' : 'AC',
                ...
                'appl_birth_date' => $request->appl_birth_date,
            ...
            if ($request->file('appl_is_img_full_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_img_full_name' => 'full_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_img_half_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_img_half_name' => 'half_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_pass_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_pass_name' => 'pass_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_copy_pass_name')) {
                $request->file('appl_is_copy_pass_name')->move(storage_path('reg/copy-pass-name'), $request->file('appl_is_copy_pass_name')->getClientOriginalName());
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_copy_pass_name' => 'copy_pass_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_yb_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_yb_name' => 'yb_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_id_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_id_name' => 'id_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_kk_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_kk_name' => 'kk_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_akta_n_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_akta_n_name' => 'akta_n_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
            if ($request->file('appl_is_akta_l_name')) {
                ...
                RegisterPackage::where('id', $new_data->id)->update(['appl_is_akta_l_name' => 'akta_l_name-' . Carbon::now()->format('yyyy_dd_mm')]);
            }
    ...
    {
        if (RegisterPackage::where('id', $registerPackage)->select('appl_st')->first() == 'NW') {
            $data = RegisterPackage::first();
            $coys = Coy::select('coy_id', 'coy_name')->get();
            $prov = Provinsi::select('prov_code', 'provinsi')->get();
            $packages = Package::select('pkg_code', 'pkg_name')->get();
    ...
    public function update(Request $request, RegisterPackage $registerPackage)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($request->file('appl_is_copy_pass_name')) {
                unlink(storage_path('reg/copy-pass-name/' . $request->old_appl_is_copy_pass_name));
                $request->file('appl_is_copy_pass_name')->move(storage_path('pkg/pkg-img'), $request->file('appl_is_copy_pass_name')->getClientOriginalName());
                $registerPackage->update(['appl_is_copy_pass_name' => $request->file('appl_is_copy_pass_name')->getClientOriginalName()]);
            }
            if ($request->file('appl_is_yb_name')) {
