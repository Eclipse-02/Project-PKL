...
return [
    ...
    */
    ...
    'links' => [
        ...
        public_path('storage/supl/supl-img') => storage_path('supl/supl-img'),
        public_path('storage/supl/ktps') => storage_path('supl/files/ktps'),
        public_path('storage/supl/mous') => storage_path('supl/files/mous'),
        public_path('storage/supl/npwps') => storage_path('supl/files/npwps'),
        public_path('storage/pkg/pkg-imgs') => storage_path('pkg/pkg-img'),
        ...
        public_path('storage/reg/copy-pass-name') => storage_path('reg/copy-pass-name'),
