...
<body class="">
    ...
    <nav
        ...
        <div class="container">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="{{ route('welcome') }}" style="width: 20vw">
                Travel
            </a>
            <button class="navbar-toggler shadow-none ms-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#navigation" aria-controls="navigation" aria-expanded="false"
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="d-lg-block d-none text-center" style="width: 20vw">
                    <a href="{{ route('welcome') }}"
                        class="btn btn-sm mb-0 me-1 bg-gradient-light">Return to The Main Page</a>
              </ul>
        </div>
    </nav>
    <!-- End Navbar -->
        ...
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Please insert the required data to create your account.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                              @csrf
                                ...
                                <div class="mb-3">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name" aria-label="Name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                    @error('name')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                                ...
                                <div class="mb-3">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email"
                                        aria-label="Email" name="email" value="{{ old('email') }}" required autocomplete="email">
                                        @error('email')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                                ...
                                <div class="mb-3">
                                    <input id="password-confirm" type="password" class="form-control" placeholder="Reenter Password"
                                        aria-label="Password" name="password_confirmation" required autocomplete="new-password">
                                </div>
