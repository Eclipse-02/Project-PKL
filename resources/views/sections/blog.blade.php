                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="thumbnail-img">
                                    <img src="{{ asset('master/assets/images/blog/b1.jpg') }}" alt="blog-img">
                        ...
                        <div class="col-sm-4 col-md-4">
                            <div class="thumbnail">
                                <h2>trending news <span>15 november 2017</span></h2>
                                <div class="thumbnail-img">
                                    <img src="{{ asset('master/assets/images/blog/b2.jpg') }}" alt="blog-img">
                                    <div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
                        ...
                        <div class="col-sm-4 col-md-4">
                            <div class="thumbnail">
                                <h2>trending news <span>15 november 2017</span></h2>
                                <div class="thumbnail-img">
                                    <img src="{{ asset('master/assets/images/blog/b3.jpg') }}" alt="blog-img">
                                    <div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
