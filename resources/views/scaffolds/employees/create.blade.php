            ...
            <div class="row mx-2">
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="empl_id" name="empl_id" placeholder="Employee ID">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="empl_nik" name="empl_nik" placeholder="Employee NIK">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Employee Name</label>
                        <input type="text" class="form-control form-control-alternative" id="empl_name" name="empl_name" placeholder="Employee Name">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select" id="position_code" name="position_code">
                            ...
                            @foreach ($positions as $i)
                                <option value="{{ $i->poss_code }}">{{ $i->poss_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="empl_up_level" name="empl_up_level" placeholder="Employee Up Level">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="empl_status" value="PB" name="empl_status" type="radio">
                        <label class="custom-control-label" for="empl_status">Probation</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="empl_status" value="PM" name="empl_status" type="radio">
                        <label class="custom-control-label" for="empl_status">Permanen</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="empl_status" value="KT" name="empl_status" type="radio">
                        <label class="custom-control-label" for="empl_status">Kontrak</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="empl_status" value="RS" name="empl_status" type="radio">
                        <label class="custom-control-label" for="empl_status">Resign</label>
                    </div>
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" id="empl_status" value="PK" name="empl_status" type="radio">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control form-control-alternative" id="empl_eff_date" name="empl_eff_date" placeholder="Effect Date">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="text" class="form-control form-control-alternative" id="empl_email" name="empl_email" placeholder="Email">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Address</label>
                        <textarea class="form-control form-control-alternative" rows="3" placeholder="Employee address..." id="empl_addr" name="empl_addr"></textarea>
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Telephone Area</label>
                        <input type="text" class="form-control form-control-alternative" id="empl_tlp_area" name="empl_tlp_area" placeholder="Telephone Area">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Telephone</label>
                        <input type="text" class="form-control form-control-alternative" id="empl_tlp" name="empl_tlp" placeholder="Telephone">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Hanphone 1</label>
                        <input type="text" class="form-control form-control-alternative" id="empl_hp01" name="empl_hp01" placeholder="Hanphone 1">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Handphone 2</label>
                        <input type="text" class="form-control form-control-alternative" id="empl_hp02" name="empl_hp02" placeholder="Handphone 2">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select" id="zip_code" name="zip_code">
                            ...
                            @foreach ($zips as $i)
                                <option value="{{ $i->sub_zip_code }}">{{ $i->zip_desc }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
