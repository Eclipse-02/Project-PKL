...
<div class="row">
    ...
    <div class="col-lg-12 mb-3">
        <form action="{{ route('suppliersubtypes.store') }}" method="post">
        @csrf
            ...
            <div class="row mx-2">
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('sub_code')is-invalid @enderror" id="sub_code" name="sub_code" placeholder="Sub Code" value="{{ old('sub_code') }}">
                        @error('sub_code')
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('sub_name')is-invalid @enderror" id="sub_name" name="sub_name" placeholder="Sub Name" value="{{ old('sub_name') }}">
                        @error('sub_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
