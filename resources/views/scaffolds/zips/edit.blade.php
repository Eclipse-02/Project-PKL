            ...
            <div class="row mx-2">
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="5" class="form-control form-control-alternative" id="sub_zip_code" name="sub_zip_code" placeholder="Max 5 Numbers" value="{{ $data->sub_zip_code }}">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Zip Desc</label>
                        <textarea class="form-control form-control-alternative" rows="3" placeholder="Write some descriptions here..." name="zip_desc" id="zip_desc">{{ $data->zip_desc }}</textarea>
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
