        ...
        @csrf
            ...
            <div class="row mx-2">
                <div class="col-lg-12 col-md-6">
                    <div class="form-group @error('provinsi') has-danger @enderror">
                        <label class="form-label">Provinsi</label>
                        <input type="text" class="form-control form-control-alternative" id="provinsi" name="provinsi" placeholder="Provinsi">
                    </div>
                    @error('provinsi')
