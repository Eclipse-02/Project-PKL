        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Create New Position Data <div class="text-muted fs-3 fw-bold d-inline"><span class="fw-bolder">/</span> Membuat Data Jabatan Baru</div></h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" action="{{ route('positions.store') }}" method="POST">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-lg form-control-solid @error('poss_code')is-invalid @enderror" type="text" name="poss_code" value="{{ old('poss_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('poss_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-lg form-control-solid @error('poss_name')is-invalid @enderror" type="text" name="poss_name" value="{{ old('poss_name') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('poss_name')
                                        <span class="invalid-feedback d-block" role="alert">
