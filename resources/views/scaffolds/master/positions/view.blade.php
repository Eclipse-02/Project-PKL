    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header cursor-pointer my-2">
            ...
            <div class="card-title m-0 flex-column">
                ...
                <div class="text-muted fs-7 fw-bold">Detail Jabatan</div>
            </div>
            <!--end::Card title-->
            <!--start::Button-->
            <!--start::Action-->
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 fv-row">
                    <span class="fw-bold text-gray-800 fs-6">{{ $data->poss_code }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
            ...
            <div class="row mb-7">
                ...
                <!--begin::Col-->
                <div class="col-lg-8 fv-row">
                    <span class="fw-bold text-gray-800 fs-6">{{ $data->poss_name }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
