        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0 flex-column">
                    <h3 class="fw-bolder m-0">Edit Sub Type Data</h3>
                    <div class="text-muted fs-7 fw-bold">Edit Sub Tipe Data</div>
                </div>
                <!--end::Card title-->
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('suppliersubtypes.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('suppliersubtypes.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('sub_code')is-invalid @enderror" type="text" id="sub_code" name="sub_code" value="{{ old('sub_code') ? old('sub_code') : $data->sub_code }}" disabled="disable" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('sub_code')
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('sub_name')is-invalid @enderror" type="text" id="sub_name" name="sub_name" value="{{ old('sub_name') ? old('sub_name') : $data->sub_name }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('sub_name')
                            <span class="invalid-feedback d-block" role="alert">
