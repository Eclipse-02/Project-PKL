        ...
        @csrf
            ...
            <div class="col-lg-12 col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('coy_addr')is-invalid @enderror" id="coy_addr" name="coy_addr" placeholder="Type your company address..." rows="3">{{ old('coy_addr') }}</textarea>
                    @error('coy_addr')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
