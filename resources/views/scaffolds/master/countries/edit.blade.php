        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0 flex-column">
                    <h3 class="fw-bolder m-0">Edit Country Data</h3>
                    <div class="text-muted fs-7 fw-bold">Edit Data Negara</div>
                </div>
                <!--end::Card title-->
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('countries.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('countries.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('con_code')is-invalid @enderror" type="text" id="con_code" name="con_code" value="{{ old('con_code') ? old('con_code') : $data->con_code }}" disabled="disabled" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('con_code')
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('con_name')is-invalid @enderror" type="text" id="con_name" name="con_name" value="{{ old('con_name') ? old('con_name') : $data->con_name }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('con_name')
                            <span class="invalid-feedback d-block" role="alert">
