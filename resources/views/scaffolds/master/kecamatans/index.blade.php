                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="create_modal_stepper">
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('kecamatans.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-lg form-control-solid @error('kec_code')is-invalid @enderror" type="text" name="kec_code" value="{{ old('kec_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('kec_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-lg form-control-solid @error('kecamatan')is-invalid @enderror" type="text" name="kecamatan" value="{{ old('kecamatan') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('kecamatan')
                                        <span class="invalid-feedback d-block" role="alert">
