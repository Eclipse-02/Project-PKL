                ...
                <table class="table table-striped gy-7 gs-7">
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                            ...
                            <th class="min-w-100px">Kode Relasi</th>
                            <th class="min-w-100px">Nama Relasi</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Create New Relation Data <div class="text-muted fs-3 fw-bold d-inline"><span class="fw-bolder">/</span> Membuat Data Relasi Baru</div></h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="create_modal_stepper">
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('relations.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('rel_code')is-invalid @enderror" type="text" name="rel_code" value="{{ old('rel_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('rel_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('rel_name')is-invalid @enderror" type="text" name="rel_name" value="{{ old('rel_name') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('rel_name')
                                        <span class="invalid-feedback d-block" role="alert">
