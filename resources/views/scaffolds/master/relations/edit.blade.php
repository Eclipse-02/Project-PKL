    ...
    <div class="col-xxl-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('relations.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('relations.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('rel_name')is-invalid @enderror" type="text" id="rel_name" name="rel_name" value="{{ old('rel_name') ? old('rel_name') : $data->rel_name }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('rel_name')
                            <span class="invalid-feedback d-block" role="alert">
