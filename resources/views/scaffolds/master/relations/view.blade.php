    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header cursor-pointer my-2">
            ...
            <div class="card-title m-0 flex-column">
                <h3 class="fw-bolder m-0">Relation Details</h3>
                <div class="text-muted fs-7 fw-bold">Detail Relasi</div>
            </div>
            <!--end::Card title-->
            <!--start::Button-->
            <!--start::Action-->
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 fv-row">
                    <span class="fw-bold text-gray-800 fs-6">{{ $data->rel_code }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
            ...
            <div class="row mb-7">
                ...
                <!--begin::Col-->
                <div class="col-lg-8">
                    <a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{ $data->rel_name }}</a>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
