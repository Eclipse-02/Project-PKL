            ...
            <div class="row mx-2">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('empl_id')is-invalid @enderror" id="empl_id" name="empl_id">
                            ...
                            @foreach ($employees as $i)
                                <option value="{{ $i->empl_id }}" {{ old('empl_id') == $i->empl_id ? 'selected' : '' }}>{{ $i->empl_name }} / {{ $i->empl_id }}</option>
                            @endforeach
                        </select>
                        @error('empl_id')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('max_session')is-invalid @enderror" id="max_session" name="max_session" placeholder="Max Session" value="{{ old('max_session') }}">
                        @error('max_session')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('expired_pwd')is-invalid @enderror" id="expired_pwd" name="expired_pwd" placeholder="Expired Password" value="{{ old('expired_pwd') }}">
                        @error('expired_pwd')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
