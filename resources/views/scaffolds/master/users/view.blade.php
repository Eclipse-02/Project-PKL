    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header cursor-pointer my-2">
            ...
            <div class="card-title m-0 flex-column">
                ...
                <div class="text-muted fs-7 fw-bold">Detail User</div>
            </div>
            <!--end::Card title-->
            <!--start::Button-->
            <!--start::Action-->
                ...
                <div class="accordion accordion-icon-toggle" id="kt_accordion_2">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse" data-bs-target="#kt_accordion_2_item_2">
                            ...
                            <h3 class="fs-4 fw-bold mb-0 ms-4">Configuration</h3>
                        </div>
                        <!--end::Header-->
                        ...
                        <div id="kt_accordion_2_item_2" class="collapse fs-6 ps-10" data-bs-parent="#kt_accordion_2">
                            ...
                            <div class="row my-7">
                                <!--begin::Label-->
                                <label class="col-lg-4 fw-bold text-muted">Sesi Maksimal</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->max_session }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label class="col-lg-4 fw-bold text-muted">Kadaluarsa Password</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ \Carbon\Carbon::parse($data->expired_pwd)->isoFormat('dddd, D MMMM Y') }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
