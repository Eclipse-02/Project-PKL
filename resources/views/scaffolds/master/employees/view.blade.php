    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header cursor-pointer my-2">
            ...
            <div class="card-title m-0 flex-column">
                ...
                <div class="text-muted fs-7 fw-bold">Detail Karyawan</div>
            </div>
            <!--end::Card title-->
            <!--start::Button-->
            <!--start::Action-->
                ...
                <div class="accordion accordion-icon-toggle" id="kt_accordion_2">
                    ...
                    <div class="mb-5">
                        ...
                        <div id="kt_accordion_2_item_1" class="fs-6 collapse show ps-10" data-bs-parent="#kt_accordion_2">
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_name }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_nik }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label class="col-lg-4 fw-bold text-muted">Bawahan Dari</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->up->empl_name }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                    ...
                    <div class="mb-5">
                        ...
                        <div id="kt_accordion_2_item_2" class="collapse fs-6 ps-10" data-bs-parent="#kt_accordion_2">
                            ...
                            <div class="row my-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_email }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_addr }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_tlp_area }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_tlp }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_hp01 }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->empl_hp02 }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                    ...
                    <div class="mb-5">
                        ...
                        <div id="kt_accordion_2_item_4" class="collapse fs-6 ps-10" data-bs-parent="#kt_accordion_2">
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label class="col-lg-4 fw-bold text-muted">Tanggal Berlaku</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <span class="fw-bolder fs-6 text-gray-800">{{ \Carbon\Carbon::parse($data->empl_eff_date)->isoFormat('dddd, D MMMM Y') }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
