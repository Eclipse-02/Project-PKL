                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="create_modal_stepper">
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('provinsis.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('prov_code')is-invalid @enderror" type="text" name="prov_code" value="{{ old('prov_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('prov_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('provinsi')is-invalid @enderror" type="text" name="provinsi" value="{{ old('provinsi') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('provinsi')
                                        <span class="invalid-feedback d-block" role="alert">
