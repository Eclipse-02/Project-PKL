    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header cursor-pointer my-2">
            ...
            <div class="card-title m-0 flex-column">
                <h3 class="fw-bolder m-0">Zip Details</h3>
                <div class="text-muted fs-7 fw-bold">Detail Kode Pos</div>
            </div>
            <!--end::Card title-->
            <!--start::Button-->
            <!--start::Action-->
                ...
                <div class="accordion accordion-icon-toggle" id="kt_accordion_2">
                        ...
                        <div id="kt_accordion_2_item_1" class="fs-6 collapse show ps-10" data-bs-parent="#kt_accordion_2">
                            ...
                            <div class="row my-7">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->zip_code }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label class="col-lg-4 fw-bold text-muted">Sub Kode Pos</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $data->sub_zip_code }}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                    ...
                    <div class="mb-5">
                        ...
                        <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse" data-bs-target="#kt_accordion_2_item_2">
                            ...
                            <h3 class="fs-4 fw-bold mb-0 ms-4">Locations</h3>
                        </div>
                        <!--end::Header-->
