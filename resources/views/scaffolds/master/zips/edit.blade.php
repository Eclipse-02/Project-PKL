    ...
    <div class="col-xxl-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('zips.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid pt-10" id="kt_stepper_example_vertical">
                ...
                <div class="flex-row-fluid py-lg-5 px-lg-15">
                    <!--begin::Form-->
                    <form class="form w-lg-500px mx-auto" action="{{ route('zips.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="current" data-kt-stepper-element="content">
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <input class="form-control form-control form-control-solid @error('sub_zip_code')is-invalid @enderror" type="text" name="sub_zip_code" value="{{ old('sub_zip_code') ? old('sub_zip_code') : $data->sub_zip_code }}" />
                                        <!--end::Input-->
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Textarea-->
                                        <textarea class="form-control form-control form-control-solid @error('zip_desc')is-invalid @enderror" name="zip_desc" data-kt-autosize="true">{{ old('zip_desc') ? old('zip_desc') : $data->zip_desc }}</textarea>
                                        <!--end::Textarea-->
