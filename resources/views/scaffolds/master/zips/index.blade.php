                ...
                <table class="table table-striped gy-7 gs-7 d-none">
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                            ...
                            <th class="min-w-100px">Sub Kode Pos</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Create New Zip Code Data <div class="text-muted fs-3 fw-bold d-inline"><span class="fw-bolder">/</span> Membuat Data Kode Pos Baru</div></h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_stepper_example_vertical">
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form w-lg-500px mx-auto" action="{{ route('zips.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="current" data-kt-stepper-element="content">
                                        <div class="w-100">
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <input class="form-control form-control form-control-solid @error('zip_code')is-invalid @enderror" type="text" name="zip_code" value="{{ old('zip_code') }}" />
                                                <!--end::Input-->
                                            ...
                                            <div class="fv-row mb-10">
                                                <!--begin::Label-->
                                                <label class="form-label required">Sub Kode Pos</label>
                                                <!--end::Label-->

                                                <!--begin::Input-->
                                                <input class="form-control form-control form-control-solid @error('sub_zip_code')is-invalid @enderror" type="text" name="sub_zip_code" value="{{ old('sub_zip_code') }}" />
                                                <!--end::Input-->
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <!--begin::Textarea-->
                                                <textarea class="form-control form-control form-control-solid @error('zip_desc')is-invalid @enderror" name="zip_desc" data-kt-autosize="true">{{ old('zip_desc') }}</textarea>
                                                <!--end::Textarea-->
