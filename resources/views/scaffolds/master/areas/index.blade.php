        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Create New Area Data <div class="text-muted fs-3 fw-bold d-inline"><span class="fw-bolder">/</span> Membuat Data Area Baru</div></h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="create_modal_stepper">
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('areas.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('area_code')is-invalid @enderror" type="text" name="area_code" value="{{ old('area_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('area_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('area_name')is-invalid @enderror" type="text" name="area_name" value="{{ old('area_name') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('area_name')
                                        <span class="invalid-feedback d-block" role="alert">
