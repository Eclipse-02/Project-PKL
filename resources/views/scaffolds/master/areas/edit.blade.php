        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0 flex-column">
                    <h3 class="fw-bolder m-0">Edit Area Data</h3>
                    <div class="text-muted fs-7 fw-bold">Edit Data Area</div>
                </div>
                <!--end::Card title-->
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('areas.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('areas.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid @error('area_code')is-invalid @enderror" type="text" id="area_code" name="area_code" value="{{ old('area_code') ? old('area_code') : $data->area_code }}" disabled="disabled" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('area_code')
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid @error('area_name')is-invalid @enderror" type="text" id="area_name" name="area_name" value="{{ old('area_name') ? old('area_name') : $data->area_name }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('area_name')
                            <span class="invalid-feedback d-block" role="alert">
