                ...
                <table class="table table-striped gy-7 gs-7">
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                            ...
                            <th class="min-w-100px">Kode Vaksin</th>
                            <th class="min-w-100px">Nama Vaksin</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Create New Vaccine Data <div class="text-muted fs-3 fw-bold d-inline"><span class="fw-bolder">/</span> Membuat Data Vaksin Baru</div></h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="create_modal_stepper">
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('vaccines.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('vc_code')is-invalid @enderror" type="text" name="vc_code" value="{{ old('vc_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('vc_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('vc_name')is-invalid @enderror" type="text" name="vc_name" value="{{ old('vc_name') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('vc_name')
                                        <span class="invalid-feedback d-block" role="alert">
