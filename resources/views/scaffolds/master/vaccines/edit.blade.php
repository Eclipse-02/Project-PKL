        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0 flex-column">
                    <h3 class="fw-bolder m-0">Edit Vaccine Data</h3>
                    <div class="text-muted fs-7 fw-bold">Edit Data Vaksin</div>
                </div>
                <!--end::Card title-->
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('vaccines.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('vaccines.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid @error('vc_code')is-invalid @enderror" type="text" id="vc_code" name="vc_code" value="{{ old('vc_code') ? old('vc_code') : $data->vc_code }}" disabled="disabled" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('vc_code')
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid @error('vc_name')is-invalid @enderror" type="text" id="vc_name" name="vc_name" value="{{ old('vc_name') ? old('vc_name') : $data->vc_name }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('vc_name')
                            <span class="invalid-feedback d-block" role="alert">
