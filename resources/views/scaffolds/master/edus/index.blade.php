                ...
                <table class="table table-striped gy-7 gs-7">
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                            ...
                            <th class="min-w-100px">Kode Edukasi</th>
                            <th class="min-w-100px">Nama Edukasi</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Create New Education Data <div class="text-muted fs-3 fw-bold d-inline"><span class="fw-bolder">/</span> Membuat Data Edukasi Baru</div></h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" action="{{ route('educations.store') }}" method="POST">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('edu_code')is-invalid @enderror" type="text" name="edu_code" value="{{ old('edu_code') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('edu_code')
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control form-control-solid @error('edu_name')is-invalid @enderror" type="text" name="edu_name" value="{{ old('edu_name') }}" />
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                    @error('edu_name')
                                        <span class="invalid-feedback d-block" role="alert">
