...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body p-9">
            ...
            <div class="row my-7">
                <!--begin::Label-->
                <label class="col-lg-4 fw-bold text-muted">Kode Kota</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8 fv-row">
                    <span class="fw-bold text-gray-800 fs-6">{{ $data->kota_code }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
            ...
            <div class="row mb-7">
                ...
                <!--begin::Col-->
                <div class="col-lg-8">
                    <a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{ $data->kota }}</a>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-4 fw-bold text-muted">Dari Provinsi</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
