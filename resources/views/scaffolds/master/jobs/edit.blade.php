    ...
    <div class="col-xxl-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <!--start::Button-->
                <!--start::Action-->
                <a href="{{ route('jobs.index') }}" class="btn btn-flex btn-light btn-light btn-active-primary fw-bolder align-self-center">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('jobs.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('job_name')is-invalid @enderror" type="text" id="job_name" name="job_name" value="{{ old('job_name') ? old('job_name') : $data->job_name }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('job_name')
                            <span class="invalid-feedback d-block" role="alert">
