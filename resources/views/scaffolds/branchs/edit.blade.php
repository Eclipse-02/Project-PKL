            ...
            <div class="row mx-2">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('branch_code')is-invalid @enderror" id="branch_code" name="branch_code" placeholder="Branch Code" value="{{ old('branch_code') ? old('branch_code') : $data->branch_code }}">
                        @error('branch_code')
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('branch_name')is-invalid @enderror" id="branch_name" name="branch_name" placeholder="Branch Name" value="{{ old('branch_name') ? old('branch_name') : $data->branch_name }}">
                        @error('branch_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('branch_addr')is-invalid @enderror" rows="3" id="branch_addr" name="branch_addr" placeholder="Branch Address">{{ old('branch_addr') ? old('branch_addr') : $data->branch_addr }}</textarea>
                        @error('branch_addr')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('branch_tlp_area')is-invalid @enderror" id="branch_tlp_area" name="branch_tlp_area" placeholder="Branch Telephone Area" value="{{ old('branch_tlp_area') ? old('branch_tlp_area') : $data->branch_tlp_area }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('branch_tlp')is-invalid @enderror" id="branch_tlp" name="branch_tlp" placeholder="Branch Telephone" value="{{ old('branch_tlp') ? old('branch_tlp') : $data->branch_tlp }}">
                        @error('branch_tlp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('branch_hp01')is-invalid @enderror" id="branch_hp01" name="branch_hp01" placeholder="Branch Hanphone 1" value="{{ old('branch_hp01') ? old('branch_hp01') : $data->branch_hp01 }}">
                        @error('branch_hp01')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('branch_hp02')is-invalid @enderror" id="branch_hp02" name="branch_hp02" placeholder="Branch Hanphone 2" value="{{ old('branch_hp02') ? old('branch_hp02') : $data->branch_hp02 }}">
                        @error('branch_hp02')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('zip_code')is-invalid @enderror" id="zip_code" name="zip_code">
                            ...
                            @foreach ($zips as $i)
                                <option value="{{ $i->zip_code }}" {{ old('zip_code') ? (old('zip_code') == $i->zip_code ? 'selected' : '') : ($data->zip_code == $i->zip_code ? 'selected' : '') }}>{{ $i->zip_code }} - {{ $i->zip_desc }}</option>
                            @endforeach
                        </select>
                        @error('zip_code')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="branch_type" value="HO" name="branch_type" type="radio" {{ old('branch_type') ? (old('branch_type') == 1 ? 'checked' : '') : ($data->branch_type == 1 ? 'checked' : '') }}>
                            <label class="custom-control-label" for="Head Office">Head Office</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="branch_type" value="B" name="branch_type" type="radio" {{ old('branch_type') ? (old('branch_type') == 0 ? 'checked' : '') : ($data->branch_type == 0 ? 'checked' : '') }}>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('area_code')is-invalid @enderror" id="area_code" name="area_code">
                            <option class="text-center" disabled>-- Pilih Area --</option>
                            @foreach ($areas as $k)
                                <option value="{{ $k->area_code }}" {{ old('area_code') ? (old('area_code') == $k->area_code ? 'selected' : '') : ($data->area_code == $k->area_code ? 'selected' : '') }}>{{ $k->area_name }}</option>
                            @endforeach
                        </select>
                        @error('area_code')
                            <span class="invalid-feedback" role="alert">
