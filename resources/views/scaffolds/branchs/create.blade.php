    ...
    <div class="col-lg-12 mb-3">
        ...
        @csrf
            ...
            <div class="row mx-2">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label @error('zip_code')is-invalid @enderror">Zip Code</label>
                        <select class="form-select" id="zip_code" name="zip_code">
                            <option class="text-center" selected disabled>-- Pilih Zip --</option>
                            @foreach ($zips as $k)
                                <option value="{{ $k->zip_code }}" {{ old('zip_code') == $k->coy_id ? 'selected' : '' }}>{{ $k->zip_code }} - {{ $k->zip_desc }}</option>
                            @endforeach
                        </select>
                        @error('branch_code')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="branch_type" value="HO" name="branch_type" type="radio" {{ old('is_active') == "HO" ? 'checked' : '' }}>
                            <label class="custom-control-label" for="Head Office">Head Office</label>
                        </div>
                        <div class="custom-control custom-radio mb-3">
                            <input class="custom-control-input" id="branch_type" value="B" name="branch_type" type="radio" {{ old('is_active') == "B" ? 'checked' : '' }}>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('area_code')is-invalid @enderror" id="area_code" name="area_code">
                            ...
                            @foreach ($areas as $k)
                                <option value="{{ $k->area_code }}" {{ old('area_code') == $p->prov_code ? 'selected' : '' }}>{{ $k->area_name }}</option>
                            @endforeach
                        </select>
                        @error('branch_code')
                            <span class="invalid-feedback d-block" role="alert">
