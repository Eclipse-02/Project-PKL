            ...
            <div class="row mx-2">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('pkg_code')is-invalid @enderror" id="pkg_code" name="pkg_code">
                            ...
                            @foreach ($packages as $k)
                                <option value="{{ $k->pkg_code }}" {{ old('pkg_code') == $k->pkg_code ? 'selected' : '' }}>{{ $k->pkg_name }} {{ $k->pkg_code }}</option>
                            @endforeach
                        </select>
                        @error('pkg_code')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="appl_st" value="NW" name="appl_st" type="radio" {{ old('appl_st') == "NW" ? 'checked' : '' }}>
                        <label class="custom-control-label">New</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="appl_st" value="ST" name="appl_st" type="radio" {{ old('appl_st') == "AC" ? 'checked' : '' }}>
                        <label class="custom-control-label">Accept</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="appl_st" value="CL" name="appl_st" type="radio" {{ old('appl_st') == "CN" ? 'checked' : '' }}>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_date')is-invalid @enderror" id="appl_date" name="appl_date" placeholder="Applicant Date" value="{{ old('appl_date') }}">
                        @error('appl_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_name')is-invalid @enderror" id="appl_name" name="appl_name" placeholder="Applicant Name" value="{{ old('appl_name') }}">
                        @error('appl_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_gender" value="1" name="appl_gender" type="radio" {{ old('appl_gender') == 1 ? 'checked' : '' }}>
                            <label class="custom-control-label">Laki-Laki</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_gender" value="2" name="appl_gender" type="radio" {{ old('appl_gender') == 2 ? 'checked' : '' }}>
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_title" value="MR" name="appl_title" type="radio" {{ old('appl_title') == "MR" ? 'checked' : '' }}>
                            <label class="custom-control-label">Mr</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_title" value="MRS" name="appl_title" type="radio" {{ old('appl_title') == "MRS" ? 'checked' : '' }}>
                            <label class="custom-control-label">Mrs</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_title" value="MS" name="appl_title" type="radio" {{ old('appl_title') == "MS" ? 'checked' : '' }}>
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_id_type" value="1" name="appl_id_type" type="radio" {{ old('appl_id_type') == 1 ? 'checked' : '' }}>
                            <label class="custom-control-label">KTP</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_id_type" value="2" name="appl_id_type" type="radio" {{ old('appl_id_type') == 2 ? 'checked' : '' }}>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_id_no')is-invalid @enderror" id="appl_id_no" name="appl_id_no" placeholder="Applicant ID No" value="{{ old('appl_id_no') }}">
                        @error('appl_id_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_birth_place')is-invalid @enderror" id="appl_birth_place" name="appl_birth_place" placeholder="Applicant Birth Place" value="{{ old('appl_birth_place') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        <label class="form-label">Applicant Status</label>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_status" value="1" name="appl_status" type="radio" {{ old('appl_status') == 1 ? 'checked' : '' }}>
                            <label class="custom-control-label">Kawin</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_status" value="2" name="appl_status" type="radio" {{ old('appl_status') == 2 ? 'checked' : '' }}>
                            <label class="custom-control-label">Belum Kawin</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_status" value="3" name="appl_status" type="radio" {{ old('appl_status') == 3 ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('con_code')is-invalid @enderror" id="con_code" name="con_code">
                            ...
                            @foreach ($countries as $i)
                                <option value="{{ $i->con_code }}" {{ old('con_code') == $i->con_code ? 'selected' : '' }}>{{ $i->con_name }} / {{ $i->con_code }}</option>
                            @endforeach
                        </select>
                        @error('con_code')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('edu_code')is-invalid @enderror" id="edu_code" name="edu_code">
                            ...
                            @foreach ($edus as $i)
                                <option value="{{ $i->edu_code }}" {{ old('edu_code') == $i->edu_code ? 'selected' : '' }}>{{ $i->edu_name }} / {{ $i->edu_code }}</option>
                            @endforeach
                        </select>
                        @error('edu_code')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('job_code')is-invalid @enderror" id="job_code" name="job_code">
                            ...
                            @foreach ($jobs as $i)
                                <option value="{{ $i->job_code }}" {{ old('job_code') == $i->job_code ? 'selected' : '' }}>{{ $i->job_name }} / {{ $i->job_code }}</option>
                            @endforeach
                        </select>
                        @error('job_code')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('branch_code')is-invalid @enderror" id="branch_code" name="branch_code">
                            ...
                            @foreach ($branches as $i)
                                <option value="{{ $i->branch_code }}" {{ old('branch_code') == $i->branch_code ? 'selected' : '' }}>{{ $i->branch_name }} / {{ $i->branch_code }}</option>
                            @endforeach
                        </select>
                        @error('branch_code')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('rel_code')is-invalid @enderror" id="rel_code" name="rel_code">
                            ...
                            @foreach ($relations as $i)
                                <option value="{{ $i->rel_code }}" {{ old('rel_code') == $i->rel_code ? 'selected' : '' }}>{{ $i->rel_name }} / {{ $i->rel_code }}</option>
                            @endforeach
                        </select>
                        @error('rel_code')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('supl_code')is-invalid @enderror" id="supl_code" name="supl_code">
                            ...
                            @foreach ($suppliers as $i)
                                <option value="{{ $i->supl_code }}" {{ old('supl_code') == $i->supl_code ? 'selected' : '' }}>{{ $i->supl_name }} / {{ $i->supl_code }}</option>
                            @endforeach
                        </select>
                        @error('supl_code')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_fth_name')is-invalid @enderror" id="appl_fth_name" name="appl_fth_name" placeholder="Applicant Father Name" value="{{ old('appl_fth_name') }}">
                        @error('appl_fth_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_mahram')is-invalid @enderror" id="appl_mahram" name="appl_mahram" placeholder="Applicant Mahram" value="{{ old('appl_mahram') }}">
                        @error('appl_mahram')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_pass_no')is-invalid @enderror" id="appl_pass_no" name="appl_pass_no" placeholder="Applicant Pass No" value="{{ old('appl_pass_no') }}">
                        @error('appl_pass_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_pass_name')is-invalid @enderror" id="appl_pass_name" name="appl_pass_name" placeholder="Applicant Pass Name" value="{{ old('appl_pass_name') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_pass_iss_date')is-invalid @enderror" id="appl_pass_iss_date" name="appl_pass_iss_date" placeholder="Applicant Pass ISS Date" value="{{ old('appl_pass_iss_date') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_pass_exp_date')is-invalid @enderror" id="appl_pass_exp_date" name="appl_pass_exp_date" placeholder="Applicant Pass Expired Date" value="{{ old('appl_pass_exp_date') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_pass_iss_palace')is-invalid @enderror" id="appl_pass_iss_palace" name="appl_pass_iss_palace" placeholder="Applicant Pass ISS Palace" value="{{ old('appl_pass_iss_palace') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_vac_name_id')is-invalid @enderror" id="appl_vac_name_id" name="appl_vac_name_id" placeholder="Applicant Vaccine Name ID" value="{{ old('appl_vac_name_id') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('vc_code_01')is-invalid @enderror" id="vc_code_01" name="vc_code_01">
                            ...
                            @foreach ($vaccines as $i)
                                <option value="{{ $i->vc_code }}" {{ old('vc_code_01') == $i->vc_code ? 'selected' : '' }}>{{ $i->vc_name }} / {{ $i->vc_code }}</option>
                            @endforeach
                        </select>
                        @error('vc_code_01')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_vac_id_date_01')is-invalid @enderror" id="appl_vac_id_date_01" name="appl_vac_id_date_01" placeholder="Applicant Vaccine ID Date 01" value="{{ old('appl_vac_id_date_01') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('vc_code_02')is-invalid @enderror" id="vc_code_02" name="vc_code_02">
                            <option selected class="text-center" selected disabled>-- Pilih Vaccine Code --</option>
                            @foreach ($vaccines as $i)
                                <option value="{{ $i->vc_code }}" {{ old('vc_code_02') == $i->vc_code ? 'selected' : '' }}>{{ $i->vc_name }} / {{ $i->vc_code }}</option>
                            @endforeach
                        </select>
                        @error('vc_code_02')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_vac_id_date_02')is-invalid @enderror" id="appl_vac_id_date_02" name="appl_vac_id_date_02" placeholder="Applicant Vaccine ID Date 02" value="{{ old('appl_vac_id_date_02') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('vc_code_03')is-invalid @enderror" id="vc_code_03" name="vc_code_03">
                            <option selected class="text-center" selected disabled>-- Pilih Vaccine Code --</option>
                            @foreach ($vaccines as $i)
                                <option value="{{ $i->vc_code }}" {{ old('vc_code_03') == $i->vc_code ? 'selected' : '' }}>{{ $i->vc_name }} / {{ $i->vc_code }}</option>
                            @endforeach
                        </select>
                        @error('vc_code_03')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_vac_id_date_03')is-invalid @enderror" id="appl_vac_id_date_03" name="appl_vac_id_date_03" placeholder="Applicant Vaccine ID Date 01" value="{{ old('appl_vac_id_date_03') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select @error('vc_code_04')is-invalid @enderror" id="vc_code_04" name="vc_code_04">
                            <option selected class="text-center" selected disabled>-- Pilih Vaccine Code --</option>
                            @foreach ($vaccines as $i)
                                <option value="{{ $i->vc_code }}" {{ old('vc_code_04') == $i->vc_code ? 'selected' : '' }}>{{ $i->vc_name }} / {{ $i->vc_code }}</option>
                            @endforeach
                        </select>
                        @error('vc_code_04')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('appl_vac_id_date_04')is-invalid @enderror" id="appl_vac_id_date_04" name="appl_vac_id_date_04" placeholder="Applicant Vaccine ID Date 01" value="{{ old('appl_vac_id_date_04') }}">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_tlp')is-invalid @enderror" id="appl_tlp" name="appl_tlp" placeholder="Package Telephone" value="{{ old('appl_tlp') }}">
                        @error('appl_tlp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('appl_email')is-invalid @enderror" id="appl_email" name="appl_email" placeholder="Package Telephone" value="{{ old('appl_email') }}">
                        @error('appl_email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_img_full" value="Y" name="appl_is_img_full" type="radio" {{ old('appl_is_img_full') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_img_full" value="N" name="appl_is_img_full" type="radio" {{ old('appl_is_img_full') == "N" ? 'checked' : '' }}>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_img_full_name')is-invalid @enderror" id="appl_is_img_full_name" name="appl_is_img_full_name" placeholder="Supplier Pic" value="{{ old('appl_is_img_full_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_img_half" value="Y" name="appl_is_img_half" type="radio" {{ old('appl_is_img_half') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_img_half" value="N" name="appl_is_img_half" type="radio" {{ old('appl_is_img_half') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_img_half_name')is-invalid @enderror" id="appl_is_img_half_name" name="appl_is_img_half_name" placeholder="Supplier Pic" value="{{ old('appl_is_img_half_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_yb" value="Y" name="appl_is_yb" type="radio" {{ old('appl_is_yb') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_yb" value="N" name="appl_is_yb" type="radio" {{ old('appl_is_yb') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                        @error('appl_is_yb')
                            <span class="invalid-feedback d-block" role="alert">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_yb_name')is-invalid @enderror" id="appl_is_yb_name" name="appl_is_yb_name" placeholder="Supplier Pic" value="{{ old('appl_is_yb_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_id" value="Y" name="appl_is_copy_id" type="radio" {{ old('appl_is_copy_id') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_id" value="N" name="appl_is_copy_id" type="radio" {{ old('appl_is_copy_id') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_id_name')is-invalid @enderror" id="appl_is_id_name" name="appl_is_id_name" placeholder="Supplier Pic" value="{{ old('appl_is_id_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_kk" value="Y" name="appl_is_copy_kk" type="radio" {{ old('appl_is_copy_kk') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_kk" value="N" name="appl_is_copy_kk" type="radio" {{ old('appl_is_copy_kk') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_kk_name')is-invalid @enderror" id="appl_is_kk_name" name="appl_is_kk_name" placeholder="Supplier Pic" value="{{ old('appl_is_kk_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_pass" value="Y" name="appl_is_copy_pass" type="radio" {{ old('appl_is_copy_pass') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_pass" value="N" name="appl_is_copy_pass" type="radio" {{ old('appl_is_copy_pass') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_pass_name')is-invalid @enderror" id="appl_is_pass_name" name="appl_is_pass_name" placeholder="Supplier Pic" value="{{ old('appl_is_pass_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_akta_n" value="Y" name="appl_is_copy_akta_n" type="radio" {{ old('appl_is_copy_akta_n') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_akta_n" value="N" name="appl_is_copy_akta_n" type="radio" {{ old('appl_is_copy_akta_n') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_akta_n_name')is-invalid @enderror" id="appl_is_akta_n_name" name="appl_is_akta_n_name" placeholder="Supplier Pic" value="{{ old('appl_is_akta_n_name') }}">
                ...
                <div class="col-lg-12 col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_akta_l" value="Y" name="appl_is_copy_akta_l" type="radio" {{ old('appl_is_copy_akta_l') == "Y" ? 'checked' : '' }}>
                            <label class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" id="appl_is_copy_akta_l" value="N" name="appl_is_copy_akta_l" type="radio" {{ old('appl_is_copy_akta_l') == "N" ? 'checked' : '' }}>
                            <label class="custom-control-label">No</label>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('appl_is_akta_l_name')is-invalid @enderror" id="appl_is_akta_l_name" name="appl_is_akta_l_name" placeholder="Supplier Pic" value="{{ old('appl_is_akta_l_name') }}">
