            ...
            <div class="row mx-2">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="empl_id" name="empl_id">
                            ...
                            @foreach ($employees as $i)
                                <option value="{{ $i->empl_id }}">{{ $i->empl_name }} / {{ $i->empl_id }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="empl_branch" name="empl_branch">
                            ...
                            @foreach ($branches as $i)
                                <option value="{{ $i->branch_code }}">{{ $i->branch_name }} / {{ $i->branch_code }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="max_session" name="max_session" placeholder="Max Session">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Expired Password</label>
                        <input type="date" class="form-control form-control-alternative" id="expired_pwd" name="expired_pwd" placeholder="Expired Password">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="email" name="email" placeholder="Email">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
