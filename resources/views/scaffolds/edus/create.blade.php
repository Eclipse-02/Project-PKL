            ...
            <div class="row mx-2">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="edu_code" name="edu_code" placeholder="Edu Code">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        <label class="form-label">Edu Name</label>
                        <input type="text" class="form-control" id="edu_name" name="edu_name" placeholder="Edu Name">
                    </div>
                </div>
