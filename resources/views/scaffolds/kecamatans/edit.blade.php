            ...
            <div class="row mx-2">
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="kecamatan" name="kecamatan" placeholder="Kecamatan" value="{{ $data->kecamatan }}">
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select" aria-label="Default select example" id="kota_code" name="kota_code">
                            ...
                            @foreach ($kotas as $k)
                                <option value="{{ $k->kota_code }}" {{ $k->kota_code == $data->kota_code ? 'selected' : '' }}>{{ $k->kota }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
