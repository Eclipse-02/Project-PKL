    ...
    <div class="mb-n10 mb-lg-n20 index-2">
        ...
        <div class="container">
            ...
            <div class="text-center mb-15 mt-10">
                ...
                <br />untuk menyelesaikan proses registrasi</div>
                <!--end::Text-->
            </div>
            <!--end::Heading-->
            <!--begin::Stepper-->
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid py-15" id="kt_stepper_example_vertical" data-kt-stepper="true">
                <!--begin::Aside-->
                <div class="d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px px-10">
                    <!--begin::Nav-->
