					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="row align-items-center g-2 mb-12">
							...
							<div class="col-lg-6 col-sm-12">
								<!--begin::Carousel-->
								<div id="bannerCarousel" class="w-100 carousel slide" data-bs-ride="carousel">
				...
				<div class="pb-15 pt-18 landing-red-bg">
					...
					<div class="container">
						...
						<div class="text-center mb-5 mb-lg-10">
							<!--begin::Title-->
							<h3 class="fs-2hx text-light mb-5" id="packages" data-kt-scroll-offset="{default: 100, lg: 150}">Paket Kami</h3>
							<!--end::Title-->
						</div>
						<!--end::Heading-->
						<!--begin::Tabs wrapper-->
